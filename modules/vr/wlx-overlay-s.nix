...

{
  ...
  hm.xdg.configFile."wlxoverlay/wayvr.yaml".source = writeYaml "wayvr.yaml" {
    version = 1;
  ...
  hm.xdg.configFile."wlxoverlay/conf.d/font.yaml".source = writeYaml "font.yaml" {
    primary_font = "CaskaydiaCove Nerd Font:weight=150";
  };

  hm.xdg.configFile."wlxoverlay/icons.dds".source = ./icons.dds;

  hm.xdg.configFile."wlxoverlay/watch.yaml".source = writeYaml "watch.yaml" {
    width = 0.1;
