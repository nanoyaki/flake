...

{
  ...
  modules.nixos.firefox =
...

    {
      ...
      programs.firefox.nativeMessagingHosts.packages = lib.optional config.services.desktopManager.plasma6.enable pkgs.kdePackages.plasma-browser-integration;
  ...
  modules.home.firefox =
...

    {
      programs.firefox = {
        enable = true;
        configPath = "${config.xdg.configHome or "${config.home.homeDirectory}/.config"}/mozilla/firefox";
        languagePacks = [
          "en-GB"
          "de"
        ];
