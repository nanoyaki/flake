...

{
  ...
  xdg.mime.defaultApplications = defaultBrowserApp;
  hm.xdg.mimeApps.defaultApplications = defaultBrowserApp;

  environment.variables.BROWSER = lib.getExe pkgs.firefox;
}
